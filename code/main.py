...
class Game():
    ...
    def import_assets(self):
        self.tmx_map = tmx_importer('..', 'data', 'maps')
        
        self.overworld_frames = {
            'water': import_folder('..', 'graphics', 'tilesets', 'water'),
            'coast': coast_importer(24, 12, '..', 'graphics', 'tilesets', 'coast'),
            'characters': all_character_importer('..', 'graphics', 'characters')
        }
        ...
        self.star_animation_frames = import_folder('..', 'graphics', 'other', 'start animation')
    ...
    def end_dialog(self, character):
        ...
        if character.nurse:
            for monster in self.player_monsters.values():
                ...
                monster.energy = monster.get_stat('energy')
        ...
        if self.tint_mode == 'tint':
            ...
            if self.tint_progress >= 255:
                ...
                if type(self.transition_target) == Battle:
                    ...
                    self.setup(self.tmx_map[self.transition_target[0]], self.transition_target[1])
