...
class MonsterIndex():
    ...
    def display_main(self, dt):
        ...
        # info
        sides = {
            'left': healthbar_rect.left, 'right': energybar_rect.left
        }
        ...
        for index, (stat, value) in enumerate(monster_stats.items()):
            ...
            # text
            text_surf = self.fonts['regular'].render(f'{stat}', False, COLORS['white'])
            ...
            draw_bar(self.display_surface, bar_rect, value, self.max_stats[stat] * monster.level, COLORS['white'], COLORS['black'], 1)
